 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".body-tabs__slider")) new core(".body-tabs__slider", {
            ...
            if (document.querySelector(".solution__slider")) new core(".solution__slider", {
                ...
                navigation: {
                    prevEl: ".solution__swiper-button-prev",
                    nextEl: ".solution__swiper-button-next"
                },
                on: {}
            });
...
***************************************************************************** */
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            var rangeSliders = document.querySelectorAll(".rs-range");
            rangeSliders.forEach((function(rangeSlider) {
                var rangeBullet = rangeSlider.previousElementSibling;
            ...
            function showSliderValue(rangeSlider, rangeBullet) {
                ...
                var bulletPosition = rangeSlider.value / rangeSlider.max * 100;
                rangeBullet.style.left = `calc(${bulletPosition}% - 25px)`;
                rangeSlider.style.background = `linear-gradient(to right, #000000 0%, #000000 ${bulletPosition}%, #ddd ${bulletPosition}%, #ddd 100%)`;
            }
        }));
        document.addEventListener("click", (function(e) {
